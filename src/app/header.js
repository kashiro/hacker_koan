    ...
    return (
      <header class="l-header flex flex-column flex-center font-style-title m-y-l">
        <div>
          ...
          <p class="header-lead m-0 m-b-m">
            Find the bible <br />for learning <br />programming languages.<span class="header-cursor fade-in-out-loop" />
          </p>
          <button
            onClick={this.handleClickMenu.bind(this)}
            type="button"
            class="reset-button">
            <i class="fa fa-angle-double-right m-r" aria-hidden="true" />SELECT
            LANGUAGE
          </button>
          <button
            ...
            type="button"
            class="reset-button">
            <i class="fa fa-question m-r" aria-hidden="true" />ABOUT
          </button>
        </div>
      </header>
    );
